...
export const AddNeedMedModal: React.FC<AddNeedMedModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-[var(--color-overlay)] backdrop-blur-md z-50 flex items-center justify-center p-4">
      <div className="bg-surface-elevated backdrop-blur-2xl rounded-3xl shadow-2xl max-w-lg w-full p-6 space-y-4 border border-border text-xs text-text animate-in zoom-in-95 max-h-[92vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-2.5 pt-3 border-t border-border">
            ...
            <button
              type="submit"
              className="px-5 py-2 bg-primary hover:bg-primary text-text font-bold rounded-xl shadow-lg shadow-primary/40 transition flex items-center gap-1.5 cursor-pointer"
            >
