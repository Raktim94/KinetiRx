#!/usr/bin/env bash
# KinetiRx quickstart — macOS & Linux.
#
...
# updates) KinetiRx into ./KinetiRx and runs its installer.
#
# Usage:
...
# succeed, and an existing ./KinetiRx checkout is updated in place rather
# than clobbered.
set -euo pipefail

REPO_URL="https://github.com/Raktim94/KinetiRx.git"
REPO_DIR="KinetiRx"
SUDO=""
...
cd "$REPO_DIR"
echo "==> Installing and starting KinetiRx..."
$SUDO ./install.sh
